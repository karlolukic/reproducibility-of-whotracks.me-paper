...
# Date: 19.04.20
# Description: 
# This code loads WhoTracks.me historical 'trackers.csv' data for global traffic, merges it, 
# and adds additional tracker info (category, mother company, etc.)
...
# 2017 (start: May 2017)
usethis::ui_todo('\n loading all historical global WhoTracks.me datasets from GitHub')
...
usethis::ui_done('\n all historical global WhoTracks.me datasets downlaoded from GitHub')
...
trackers_DT[, tracker_category := stringr::str_replace(tracker_category, 'site_analytics', 'Site analytics')]
trackers_DT[, tracker_category := stringr::str_replace(tracker_category, 'advertising', 'Advertising')]
trackers_DT[, tracker_category := stringr::str_replace(tracker_category, 'essential', 'Essential')]
trackers_DT[, tracker_category := stringr::str_replace(tracker_category, 'cdn', 'CDN')]
trackers_DT[, tracker_category := stringr::str_replace(tracker_category, 'hosting', 'Hosting')]
trackers_DT[, tracker_category := stringr::str_replace(tracker_category, 'social_media', 'Social media')]
trackers_DT[, tracker_category := stringr::str_replace(tracker_category, 'audio_video_player', 'Audio video player')]
trackers_DT[, tracker_category := stringr::str_replace(tracker_category, 'extensions', 'Extensions')]
trackers_DT[, tracker_category := stringr::str_replace(tracker_category, 'customer_interaction', 'Customer interaction')]
trackers_DT[, tracker_category := stringr::str_replace(tracker_category, 'pornvertising', 'Adult advertising')]
trackers_DT[, tracker_category := stringr::str_replace(tracker_category, 'misc', 'Misc')]
trackers_DT[, tracker_category := stringr::str_replace(tracker_category, 'unknown', 'Unknown')]
trackers_DT[, tracker_category := stringr::str_replace(tracker_category, 'comments', 'Comments')]
